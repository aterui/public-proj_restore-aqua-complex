...
Trichoptera emerged from spring to early summer, contributing to an earlier emergence peak in streams.
However, further decomposing compositional influences on emergence phenology was not possible, as we identified aquatic insects only to the order level.
Increasing taxonomic resolution seems crucial, given that Diptera in streams and wetlands exhibited distinct phenological patterns despite being in the same order.
