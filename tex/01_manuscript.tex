...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{output/figure_emg.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{output/figure_cv_rho.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{output/figure_bat_habitat.png}
