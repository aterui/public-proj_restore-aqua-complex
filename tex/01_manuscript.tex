...
\begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{output/figure_emg.tif}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{output/figure_cv_rho.tif}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{output/figure_bat_habitat.tif}
